...
//     function getLpAmount(uint256 _tokenId, uint256 _amount)
//         public
//         pure
//         returns (uint256)
//     {
...
//             boost = 1003;
//         } else if (_tokenId == 46) {
//             // Bag of Rare Mushrooms 8.21
//             boost = 821;
//         } else if (_tokenId == 47) {
//             // Bait for Monsters 9.73
//             boost = 973;
//         } else if (_tokenId == 48) {
//             // Beetle-wing 1.00
//             boost = 100;
...
//             boost = 204;
//         } else if (_tokenId == 51) {
//             // Bottomless Elixir 10.15
//             boost = 1015;
//         } else if (_tokenId == 52) {
//             // Cap of Invisibility 10.15
//             boost = 1015;
//         } else if (_tokenId == 53) {
//             // Carriage 8.09
//             boost = 809;
...
//             boost = 101;
//         } else if (_tokenId == 82) {
//             // Favor from the Gods 7.39
//             boost = 739;
//         } else if (_tokenId == 91) {
//             // Framed Butterfly 7.79
//             boost = 779;
//         } else if (_tokenId == 92) {
//             // Gold Coin 1.03
//             boost = 103;
...
//             boost = 1052;
//         } else if (_tokenId == 98) {
//             // Immovable Stone 9.65
//             boost = 965;
//         } else if (_tokenId == 99) {
//             // Ivory Breastpin 8.49
//             boost = 849;
...
//             // Snow White Feather 8.54
//             boost = 854;
//         } else if (_tokenId == 161) {
//             // Thread of Divine Silk 9.77
//             boost = 977;
//         } else if (_tokenId == 162) {
//             // Unbreakable Pocketwatch 7.91
//             boost = 791;
...
//     function getAllUserTokenIds(address _user)
//         public
//         view
...
//     function pendingRewardsPosition(address _user, uint256 _tokenId)
//         public
//         view
//         returns (uint256 pending)
//     {
//         UserInfo storage user = userInfo[_user][_tokenId];
//         pending = (((user.lpAmount * accMagicPerShare) / ONE).toInt256() -
//             user.rewardDebt).toUint256();
//     }

//     function pendingRewardsAll(address _user)
//         external
//         view
//         returns (uint256 pending)
//     {
...
//         int256 accumulatedMagic = ((user.lpAmount * accMagicPerShare) / ONE)
//             .toInt256();
...
//     function withdrawAndHarvestPosition(uint256 _tokenId, uint256 _amount)
//         public
//     {
...
//     function _addDeposit(address _user, uint256 _tokenId)
//         internal
...
//         if (
//             allUserTokenIds[_user].length == 0 ||
//             allUserTokenIds[_user][tokenIndex] != _tokenId
//         ) {
